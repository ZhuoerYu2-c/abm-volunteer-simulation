...
\vspace{0.5em}
{\centering\includegraphics[width=0.85\textwidth,height=0.45\textheight]{../results/fig1_overall_trends}\par}
\vspace{0.5em}
...
\vspace{0.5em}
{\centering\includegraphics[width=0.85\textwidth,height=0.40\textheight]{../results/fig6_sensitivity}\par}
\vspace{0.5em}
...
\item Mesa Developer Team (2020). Mesa: Agent-based modeling in Python.

\item Omoto, Allen M. and Snyder, Mark (1995). Sustained helping without obligation: Motivation, longevity of service, and perceived attitude change among AIDS volunteers. \\textit{Journal of Personality and Social Psychology}, 68, 671--686.

\item Penrod, J. (2011). Youth volunteers' reasons for leaving a community coalition: A qualitative study. \\textit{Health Education Research}, 26, 689--702.

\item Smith, David H. and Stebbins, Robert A. and Grotz, Jurgen (2010). The Palgrave Handbook of Volunteering, Civic Participation, and Nonprofit Associations.

\item Bourdieu, Pierre (1984). Distinction: A Social Critique of the Judgement of Taste.

\item Giddens, Anthony (1984). The Constitution of Society: Outline of the Theory of Structuration.

\item Railsback, Steven F. and Grimm, Volker (2019). Agent-based and Individual-based Modeling: A Practical Introduction.

\item Grimm, Volker and Railsback, Steven F. and Vincenot, Anders E. (2020). OODD: The ODD+ D protocol for describing agent-based models. \\textit{Journal of Artificial Societies and Social Simulation}, 23, 1--26.

\item Macal, Charles M. and North, Michael J. (2014). Introductory Tutorial: Agent-based Modeling and Simulation. In Proceedings of the 2014 Winter Simulation Conference (pp. 1--20). IEEE Press.

\item Moon, Il-Chul and Kim, Dongjun and Yun, Tae-Sub and Bae, Jang Won and Kang, Dong-oh and Paik, Euihyun (2014). Data-driven Automatic Calibration for Validation of Agent-Based Social Simulations. In Proceedings of the 2014 Winter Simulation Conference (pp. 1--20). IEEE Press.

\item Gursoy, Furkan and Badur, Bertan (2024). An Agent-Based Modeling Approach to Brain Drain. \\textit{IEEE Transactions on Engineering Management}, 71, 234--251.

\item Adornetto, Carlo and Mora, Adrian and Hu, Kai and Izquierdo Garcia, Leticia and Atchade-Adelomou, Parfait and Greco, Gianluigi and Larson, Kent (2024). Generative Agents in Agent-Based Modeling: Overview, Validation, and Emerging Challenges. \\textit{IEEE Transactions on Emerging Topics in Computational Intelligence}, .

\item Belfrage, Michael and Loriga, Fabian and Davidsson, Paul (2024). Simulating Change: A Systematic Literature Review of Agent-Based Models for Policy-Making. In Proceedings of the 2024 Winter Simulation Conference (pp. 1--20). IEEE Press.

\item Yu, Songmin and Polcz, P. (2019). An Agent-Based Framework for Policy Simulation: Modeling Heterogeneous Behaviors with Modified Sigmoid Function and Evolutionary Training. \\textit{IEEE Transactions on Computational Social Systems}, 6, 1215--1227.

\item 张网成 (2016). 大学生志愿者挫折反应及对策调查数据.

\item 张网成 and 牛雪霏 (2023). 大学生志愿参与阶梯式下跌的现象分析. \\textit{中国青年研究}, , 89--97.
